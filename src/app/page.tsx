    ...
    <div className="bg-[#f6f7f9] min-h-screen p-4 sm:p-6 lg:p-20 flex flex-col gap-10 font-[family-name:var(--font-geist-sans)]">
      ...
      >
        <div className="relative flex flex-col items-center">
          ...
          />
          <Link href={'/payment'}>
          <button className="absolute bottom-20 left-1 m-3 bg-blue-600 text-white font-normal py-2 px-4 rounded hidden lg:block hover:bg-blue-500 hover:scale-105 transition duration-300">
            Rental Car
          </button></Link>
        </div>
        ...
        <div className="relative flex flex-col items-center">
          ...
          />
          <Link href={'/payment'}>
          <button className="absolute bottom-20 left-1 m-3 bg-blue-400 text-white font-normal py-2 px-4 rounded hidden lg:block hover:bg-blue-600 hover:scale-105 transition duration-300">
            Rental Car
          </button></Link>
        </div>
      </section>
      ...
      <section className="w-full flex flex-wrap sm:flex-nowrap items-center justify-center sm:justify-between gap-4 sm:gap-8">
        ...
        <div className="w-[85px] h-[70px] bg-blue-600 hover:bg-blue-500 rounded-lg flex items-center justify-center">
          <img src="/Swap.png" alt="Switch"  width={30} height={30}/>
        ...
        <div className="sec grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="w-full max-w-[304px] mx-auto h-auto flex flex-col justify-between">
            ...
            <CardFooter className="w-full flex items-center justify-between">
              ...
              <Link href={'/payment'}><button className="bg-[#3563e9] p-2 text-white rounded-md hover:bg-blue-600 hover:scale-105 transition duration-300">Rent Now</button></Link>
            </CardFooter>
          </Card>
...
<button className="bg-[#3563e9] px-4 py-2 text-white rounded-md mt-5 hover:bg-blue-600 hover:scale-105 transition duration-300">
  Show More Cars
</button>
        </Link>
      </section>
